...
*/
$apiInstance = new DBSeller\ApiPixItau\Api\CobrancaComVencimentoCobvApi(new GuzzleHttp\Client(),$config);
$txid = "123"; 
...
------------ | ------------- | ------------- | -------------
*CobrancaComVencimentoCobvApi* | [**getcobv**](docs/Api/CobrancaComVencimentoCobvApi.md#getcobv) | **GET** /cobv | 
*CobrancaComVencimentoCobvApi* | [**getcobvtxid**](docs/Api/CobrancaComVencimentoCobvApi.md#getcobvtxid) | **GET** /cobv/{txid} | 
*CobrancaComVencimentoCobvApi* | [**getcobvtxidqrcode**](docs/Api/CobrancaComVencimentoCobvApi.md#getcobvtxidqrcode) | **GET** /cobv/{txid}/qrcode | 
*CobrancaComVencimentoCobvApi* | [**patchcobvtxid**](docs/Api/CobrancaComVencimentoCobvApi.md#patchcobvtxid) | **PATCH** /cobv/{txid} | 
*CobrancaComVencimentoCobvApi* | [**putcobvtxid**](docs/Api/CobrancaComVencimentoCobvApi.md#putcobvtxid) | **PUT** /cobv/{txid} | 
*CobrancaImediataCobApi* | [**getcob**](docs/Api/CobrancaImediataCobApi.md#getcob) | **GET** /cob | 
*CobrancaImediataCobApi* | [**getcobtxid**](docs/Api/CobrancaImediataCobApi.md#getcobtxid) | **GET** /cob/{txid} | 
*CobrancaImediataCobApi* | [**getcobtxidqrcode**](docs/Api/CobrancaImediataCobApi.md#getcobtxidqrcode) | **GET** /cob/{txid}/qrcode | 
*CobrancaImediataCobApi* | [**patchcobtxid**](docs/Api/CobrancaImediataCobApi.md#patchcobtxid) | **PATCH** /cob/{txid} | 
*CobrancaImediataCobApi* | [**postcob**](docs/Api/CobrancaImediataCobApi.md#postcob) | **POST** /cob | 
*CobrancaImediataCobApi* | [**putcobtxid**](docs/Api/CobrancaImediataCobApi.md#putcobtxid) | **PUT** /cob/{txid} | 
...
*LoteDeCobrancaComVencimentoLotecobvApi* | [**getlotecobv**](docs/Api/LoteDeCobrancaComVencimentoLotecobvApi.md#getlotecobv) | **GET** /lotecobv | 
*LoteDeCobrancaComVencimentoLotecobvApi* | [**getlotecobvid**](docs/Api/LoteDeCobrancaComVencimentoLotecobvApi.md#getlotecobvid) | **GET** /lotecobv/{id} | 
*LoteDeCobrancaComVencimentoLotecobvApi* | [**patchlotecobvid**](docs/Api/LoteDeCobrancaComVencimentoLotecobvApi.md#patchlotecobvid) | **PATCH** /lotecobv/{id} | 
*LoteDeCobrancaComVencimentoLotecobvApi* | [**putlotecobvid**](docs/Api/LoteDeCobrancaComVencimentoLotecobvApi.md#putlotecobvid) | **PUT** /lotecobv/{id} | 
