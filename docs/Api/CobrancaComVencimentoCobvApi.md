# DBSeller\ApiPixItau\CobrancaComVencimentoCobvApi

All URIs are relative to *https:/secure.api.itau/pix_recebimentos/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getcobv**](CobrancaComVencimentoCobvApi.md#getcobv) | **GET** /cobv | 
[**getcobvtxid**](CobrancaComVencimentoCobvApi.md#getcobvtxid) | **GET** /cobv/{txid} | 
[**getcobvtxidqrcode**](CobrancaComVencimentoCobvApi.md#getcobvtxidqrcode) | **GET** /cobv/{txid}/qrcode | 
[**patchcobvtxid**](CobrancaComVencimentoCobvApi.md#patchcobvtxid) | **PATCH** /cobv/{txid} | 
[**putcobvtxid**](CobrancaComVencimentoCobvApi.md#putcobvtxid) | **PUT** /cobv/{txid} | 

# **getcobv**
> \DBSeller\ApiPixItau\Model\CobrancasVencimento getcobv($inicio, $fim, $cpf, $cnpj, $location_presente, $status, $lote_cob_v_id, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $x_correlation_id)
...
$apiInstance = new DBSeller\ApiPixItau\Api\CobrancaComVencimentoCobvApi(
...
try {
    ...
    echo 'Exception when calling CobrancaComVencimentoCobvApi->getcobv: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\DBSeller\ApiPixItau\Model\CobrancasVencimento**](../Model/CobrancasVencimento.md)
...
# **getcobvtxid**
> \DBSeller\ApiPixItau\Model\CobrancaVencimento getcobvtxid($txid, $revisao)
...
try {
    ...
    echo 'Exception when calling CobrancaComVencimentoCobvApi->getcobvtxid: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\DBSeller\ApiPixItau\Model\CobrancaVencimento**](../Model/CobrancaVencimento.md)
...
# **getcobvtxidqrcode**
> \DBSeller\ApiPixItau\Model\Qrcode getcobvtxidqrcode($txid, $x_correlation_id)
...
try {
    ...
    echo 'Exception when calling CobrancaComVencimentoCobvApi->getcobvtxidqrcode: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
$txid = "txid_example"; // string | Txid a ser consultado.
$body = new \DBSeller\ApiPixItau\Model\CobrancaVencimentoPatchRequest(); // \DBSeller\ApiPixItau\Model\CobrancaVencimentoPatchRequest | 

try {
    $apiInstance->patchcobvtxid($txid, $body);
} catch (Exception $e) {
    echo 'Exception when calling CobrancaComVencimentoCobvApi->patchcobvtxid: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
------------- | ------------- | ------------- | -------------
 **txid** | **string**| Txid a ser consultado. |
 **body** | [**\DBSeller\ApiPixItau\Model\CobrancaVencimentoPatchRequest**](../Model/CobrancaVencimentoPatchRequest.md)|  | [optional]
...
$txid = "txid_example"; // string | Txid a ser consultado.
$body = new \DBSeller\ApiPixItau\Model\CobrancaVencimentoPutRequest(); // \DBSeller\ApiPixItau\Model\CobrancaVencimentoPutRequest | 

try {
    $apiInstance->putcobvtxid($txid, $body);
} catch (Exception $e) {
    echo 'Exception when calling CobrancaComVencimentoCobvApi->putcobvtxid: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
------------- | ------------- | ------------- | -------------
 **txid** | **string**| Txid a ser consultado. |
 **body** | [**\DBSeller\ApiPixItau\Model\CobrancaVencimentoPutRequest**](../Model/CobrancaVencimentoPutRequest.md)|  | [optional]
