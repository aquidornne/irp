# DBSeller\ApiPixItau\LocationEndereoURLEImagemApi
...
# **deletelocidtxid**
> \DBSeller\ApiPixItau\Model\LocationPostResponse deletelocidtxid($id, $x_correlation_id)
...
$apiInstance = new DBSeller\ApiPixItau\Api\LocationEndereoURLEImagemApi(
...
[**\DBSeller\ApiPixItau\Model\LocationPostResponse**](../Model/LocationPostResponse.md)
...
# **getloc**
> \DBSeller\ApiPixItau\Model\Locs getloc($inicio, $fim, $tx_id_presente, $tipo_cob, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $x_correlation_id)
...
[**\DBSeller\ApiPixItau\Model\Locs**](../Model/Locs.md)
...
# **getlocid**
> \DBSeller\ApiPixItau\Model\LocationIdGetResponse getlocid($id)
...
[**\DBSeller\ApiPixItau\Model\LocationIdGetResponse**](../Model/LocationIdGetResponse.md)
...
$body = new \DBSeller\ApiPixItau\Model\LocationPostRequest(); // \DBSeller\ApiPixItau\Model\LocationPostRequest | 
$x_correlation_id = "x_correlation_id_example"; // string | Identificador de correlação que serve como um agrupar dentro da estrutura de audit trail
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\DBSeller\ApiPixItau\Model\LocationPostRequest**](../Model/LocationPostRequest.md)|  | [optional]
 **x_correlation_id** | **string**| Identificador de correlação que serve como um agrupar dentro da estrutura de audit trail | [optional]
