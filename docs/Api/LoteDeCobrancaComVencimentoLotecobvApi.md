# DBSeller\ApiPixItau\LoteDeCobrancaComVencimentoLotecobvApi

All URIs are relative to *https:/secure.api.itau/pix_recebimentos/v2*

Method | HTTP request | Description
------------- | ------------- | -------------
[**getlotecobv**](LoteDeCobrancaComVencimentoLotecobvApi.md#getlotecobv) | **GET** /lotecobv | 
[**getlotecobvid**](LoteDeCobrancaComVencimentoLotecobvApi.md#getlotecobvid) | **GET** /lotecobv/{id} | 
[**patchlotecobvid**](LoteDeCobrancaComVencimentoLotecobvApi.md#patchlotecobvid) | **PATCH** /lotecobv/{id} | 
[**putlotecobvid**](LoteDeCobrancaComVencimentoLotecobvApi.md#putlotecobvid) | **PUT** /lotecobv/{id} | 

# **getlotecobv**
> \DBSeller\ApiPixItau\Model\LoteCobrancaVencimentoGetResponse getlotecobv($inicio, $fim, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $x_correlation_id)
...
$apiInstance = new DBSeller\ApiPixItau\Api\LoteDeCobrancaComVencimentoLotecobvApi(
...
try {
    ...
    echo 'Exception when calling LoteDeCobrancaComVencimentoLotecobvApi->getlotecobv: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\DBSeller\ApiPixItau\Model\LoteCobrancaVencimentoGetResponse**](../Model/LoteCobrancaVencimentoGetResponse.md)
...
# **getlotecobvid**
> \DBSeller\ApiPixItau\Model\LoteCobrancaVencimentoIdGetResponse getlotecobvid($id)
...
try {
    ...
    echo 'Exception when calling LoteDeCobrancaComVencimentoLotecobvApi->getlotecobvid: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\DBSeller\ApiPixItau\Model\LoteCobrancaVencimentoIdGetResponse**](../Model/LoteCobrancaVencimentoIdGetResponse.md)
...
$id = "id_example"; // string | id da devolução
$body = new \DBSeller\ApiPixItau\Model\LoteCobrancaVencimentoPatchRequest(); // \DBSeller\ApiPixItau\Model\LoteCobrancaVencimentoPatchRequest | 

try {
    $apiInstance->patchlotecobvid($id, $body);
} catch (Exception $e) {
    echo 'Exception when calling LoteDeCobrancaComVencimentoLotecobvApi->patchlotecobvid: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
------------- | ------------- | ------------- | -------------
 **id** | **string**| id da devolução |
 **body** | [**\DBSeller\ApiPixItau\Model\LoteCobrancaVencimentoPatchRequest**](../Model/LoteCobrancaVencimentoPatchRequest.md)|  | [optional]
...
$id = "id_example"; // string | id da devolução
$body = new \DBSeller\ApiPixItau\Model\LoteCobrancaVencimentoPutRequest(); // \DBSeller\ApiPixItau\Model\LoteCobrancaVencimentoPutRequest | 

try {
    $apiInstance->putlotecobvid($id, $body);
} catch (Exception $e) {
    echo 'Exception when calling LoteDeCobrancaComVencimentoLotecobvApi->putlotecobvid: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
------------- | ------------- | ------------- | -------------
 **id** | **string**| id da devolução |
 **body** | [**\DBSeller\ApiPixItau\Model\LoteCobrancaVencimentoPutRequest**](../Model/LoteCobrancaVencimentoPutRequest.md)|  | [optional]
