# DBSeller\ApiPixItau\PixRecebidosPixApi
...
# **getpix**
> \DBSeller\ApiPixItau\Model\Pixs getpix($inicio, $fim, $txid, $txid_presente, $devolucao_presente, $cpf, $cnpj, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $x_correlation_id)
...
$apiInstance = new DBSeller\ApiPixItau\Api\PixRecebidosPixApi(
...
[**\DBSeller\ApiPixItau\Model\Pixs**](../Model/Pixs.md)
...
# **getpixe2eid**
> \DBSeller\ApiPixItau\Model\Pix getpixe2eid($e2eid)
...
[**\DBSeller\ApiPixItau\Model\Pix**](../Model/Pix.md)
...
> \DBSeller\ApiPixItau\Model\Devolucao getpixe2eiddevolucaoid($e2eid, $id)
...
[**\DBSeller\ApiPixItau\Model\Devolucao**](../Model/Devolucao.md)
...
$e2eid = "e2eid_example"; // string | Id fim a fim da transação.
$id = "id_example"; // string | id da devolução
$body = new \DBSeller\ApiPixItau\Model\DevolucaoPutRequest(); // \DBSeller\ApiPixItau\Model\DevolucaoPutRequest | 
 ...
 **e2eid** | **string**| Id fim a fim da transação. |
 **id** | **string**| id da devolução |
 **body** | [**\DBSeller\ApiPixItau\Model\DevolucaoPutRequest**](../Model/DevolucaoPutRequest.md)|  | [optional]
