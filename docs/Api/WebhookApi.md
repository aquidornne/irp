# DBSeller\ApiPixItau\WebhookApi
...
$apiInstance = new DBSeller\ApiPixItau\Api\WebhookApi(
...
# **getwebhook**
> \DBSeller\ApiPixItau\Model\Webhooks getwebhook($inicio, $fim, $paginacao_pagina_atual, $paginacao_itens_por_pagina, $x_correlation_id)
...
[**\DBSeller\ApiPixItau\Model\Webhooks**](../Model/Webhooks.md)
...
# **getwebhookchave**
> \DBSeller\ApiPixItau\Model\Webhook getwebhookchave($chave)
...
[**\DBSeller\ApiPixItau\Model\Webhook**](../Model/Webhook.md)
...
$chave = "chave_example"; // string | Chave de endereçamento do recebedor
$body = new \DBSeller\ApiPixItau\Model\WebhookPut(); // \DBSeller\ApiPixItau\Model\WebhookPut | 
...
------------- | ------------- | ------------- | -------------
 **chave** | **string**| Chave de endereçamento do recebedor |
 **body** | [**\DBSeller\ApiPixItau\Model\WebhookPut**](../Model/WebhookPut.md)|  | [optional]
