...
/**
 * CobrancaComVencimentoCobvApi Class Doc Comment
 *
 * @category Class
 * @package  DBSeller\ApiPixItau
 * @author   Swagger Codegen team
...
class CobrancaComVencimentoCobvApi
{
     ...
     * @return \DBSeller\ApiPixItau\Model\CobrancasVencimento
     */
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DBSeller\ApiPixItau\Model\CobrancasVencimento, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\DBSeller\ApiPixItau\Model\CobrancasVencimento';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DBSeller\ApiPixItau\Model\CobrancasVencimento',
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DBSeller\ApiPixItau\Model\CobrancaVencimento
     */
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DBSeller\ApiPixItau\Model\CobrancaVencimento, HTTP status code, HTTP response headers (array of strings)
     */
    public function getcobvtxidWithHttpInfo($txid, $revisao = null)
    {
        $returnType = '\DBSeller\ApiPixItau\Model\CobrancaVencimento';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DBSeller\ApiPixItau\Model\CobrancaVencimento',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $txid Txid a ser consultado. (required)
     * @param  \DBSeller\ApiPixItau\Model\CobrancaVencimentoPatchRequest $body body (optional)
     *
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $txid Txid a ser consultado. (required)
     * @param  \DBSeller\ApiPixItau\Model\CobrancaVencimentoPatchRequest $body (optional)
     *
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DBSeller\ApiPixItau\Model\CobrancaVencimentoPatchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $txid Txid a ser consultado. (required)
     * @param  \DBSeller\ApiPixItau\Model\CobrancaVencimentoPutRequest $body body (optional)
     *
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $txid Txid a ser consultado. (required)
     * @param  \DBSeller\ApiPixItau\Model\CobrancaVencimentoPutRequest $body (optional)
     *
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DBSeller\ApiPixItau\Model\CobrancaVencimentoPutResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
