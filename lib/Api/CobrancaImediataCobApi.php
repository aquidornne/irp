...
/**
 * CobrancaImediataCobApi Class Doc Comment
 *
 * @category Class
 * @package  DBSeller\ApiPixItau
 * @author   Swagger Codegen team
...
class CobrancaImediataCobApi
{
     ...
     * @return \DBSeller\ApiPixItau\Model\Cobrancas
     */
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DBSeller\ApiPixItau\Model\Cobrancas, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\DBSeller\ApiPixItau\Model\Cobrancas';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DBSeller\ApiPixItau\Model\Cobrancas',
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DBSeller\ApiPixItau\Model\Cobranca
     */
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DBSeller\ApiPixItau\Model\Cobranca, HTTP status code, HTTP response headers (array of strings)
     */
    public function getcobtxidWithHttpInfo($txid, $revisao = null)
    {
        $returnType = '\DBSeller\ApiPixItau\Model\Cobranca';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DBSeller\ApiPixItau\Model\Cobranca',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DBSeller\ApiPixItau\Model\Qrcode
     */
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DBSeller\ApiPixItau\Model\Qrcode, HTTP status code, HTTP response headers (array of strings)
     */
    public function getcobtxidqrcodeWithHttpInfo($txid, $x_correlation_id = null)
    {
        $returnType = '\DBSeller\ApiPixItau\Model\Qrcode';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DBSeller\ApiPixItau\Model\Qrcode',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $txid Txid a ser consultado. (required)
     * @param  \DBSeller\ApiPixItau\Model\CobrancaPatchRequest $body body (optional)
     *
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DBSeller\ApiPixItau\Model\CobrancaPatchResponse
     */
     ...
     *
     * @param  string $txid Txid a ser consultado. (required)
     * @param  \DBSeller\ApiPixItau\Model\CobrancaPatchRequest $body (optional)
     *
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DBSeller\ApiPixItau\Model\CobrancaPatchResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchcobtxidWithHttpInfo($txid, $body = null)
    {
        $returnType = '\DBSeller\ApiPixItau\Model\CobrancaPatchResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DBSeller\ApiPixItau\Model\CobrancaPatchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Operation postcob
     *
     * @param  \DBSeller\ApiPixItau\Model\CobrancaImediataPostRequest $body body (optional)
     * @param  string $x_correlation_id Identificador de correlação que serve como um agrupar dentro da estrutura de audit trail (optional)
     *
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \DBSeller\ApiPixItau\Model\CobrancaImediataPostRequest $body (optional)
     * @param  string $x_correlation_id Identificador de correlação que serve como um agrupar dentro da estrutura de audit trail (optional)
     *
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DBSeller\ApiPixItau\Model\CobrancaPutResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $txid Txid a ser consultado. (required)
     * @param  \DBSeller\ApiPixItau\Model\CobrancaPutRequest $body body (optional)
     *
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $txid Txid a ser consultado. (required)
     * @param  \DBSeller\ApiPixItau\Model\CobrancaPutRequest $body (optional)
     *
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
