...
class LocationEndereoURLEImagemApi
{
     ...
     * @return \DBSeller\ApiPixItau\Model\LocationPostResponse
     */
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DBSeller\ApiPixItau\Model\LocationPostResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function deletelocidtxidWithHttpInfo($id, $x_correlation_id = null)
    {
        $returnType = '\DBSeller\ApiPixItau\Model\LocationPostResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DBSeller\ApiPixItau\Model\LocationPostResponse',
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DBSeller\ApiPixItau\Model\Locs
     */
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DBSeller\ApiPixItau\Model\Locs, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\DBSeller\ApiPixItau\Model\Locs';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DBSeller\ApiPixItau\Model\Locs',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DBSeller\ApiPixItau\Model\LocationIdGetResponse
     */
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DBSeller\ApiPixItau\Model\LocationIdGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getlocidWithHttpInfo($id)
    {
        $returnType = '\DBSeller\ApiPixItau\Model\LocationIdGetResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DBSeller\ApiPixItau\Model\LocationIdGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Operation postloc
     *
     * @param  \DBSeller\ApiPixItau\Model\LocationPostRequest $body body (optional)
     * @param  string $x_correlation_id Identificador de correlação que serve como um agrupar dentro da estrutura de audit trail (optional)
     *
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \DBSeller\ApiPixItau\Model\LocationPostRequest $body (optional)
     * @param  string $x_correlation_id Identificador de correlação que serve como um agrupar dentro da estrutura de audit trail (optional)
     *
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
