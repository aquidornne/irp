...
class PixRecebidosPixApi
{
     ...
     * @return \DBSeller\ApiPixItau\Model\Pixs
     */
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DBSeller\ApiPixItau\Model\Pixs, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\DBSeller\ApiPixItau\Model\Pixs';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DBSeller\ApiPixItau\Model\Pixs',
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DBSeller\ApiPixItau\Model\Pix, HTTP status code, HTTP response headers (array of strings)
     */
    public function getpixe2eidWithHttpInfo($e2eid)
    {
        $returnType = '\DBSeller\ApiPixItau\Model\Pix';
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \DBSeller\ApiPixItau\Model\Devolucao
     */
     ...
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \DBSeller\ApiPixItau\Model\Devolucao, HTTP status code, HTTP response headers (array of strings)
     */
    public function getpixe2eiddevolucaoidWithHttpInfo($e2eid, $id)
    {
        $returnType = '\DBSeller\ApiPixItau\Model\Devolucao';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DBSeller\ApiPixItau\Model\Devolucao',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $e2eid Id fim a fim da transação. (required)
     * @param  string $id id da devolução (required)
     * @param  \DBSeller\ApiPixItau\Model\DevolucaoPutRequest $body body (optional)
     *
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @param  string $e2eid Id fim a fim da transação. (required)
     * @param  string $id id da devolução (required)
     * @param  \DBSeller\ApiPixItau\Model\DevolucaoPutRequest $body (optional)
     *
     * @throws \DBSeller\ApiPixItau\ApiException on non-2xx response
     * @throws \InvalidArgumentException
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\DBSeller\ApiPixItau\Model\DevolucaoPutResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
