<?php
/**
 * CobrancaPatchRequestCalendario
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CobrancaPatchRequestCalendario Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CobrancaPatchRequestCalendario implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'cobrancaPatchRequest_calendario';
    ...
    {
        $this->container['expiracao'] = isset($data['expiracao']) ? $data['expiracao'] : null;
    }
     ...
     * Sets expiracao
     *
     * @param int $expiracao Tempo de vida da cobrança, especificado em segundos a partir da data de criação (Calendario.criacao).
     *
     * @return $this
     */
