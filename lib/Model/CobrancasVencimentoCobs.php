...
/**
 * CobrancasVencimentoCobs Class Doc Comment
 *
 * @category Class
 * @package  DBSeller\ApiPixItau
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CobrancasVencimentoCobs implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'cobrancasVencimento_cobs';
    ...
    protected static $swaggerTypes = [
        'calendario' => '\DBSeller\ApiPixItau\Model\Calendario',
'devedor' => '\DBSeller\ApiPixItau\Model\Devedor',
'loc' => '\DBSeller\ApiPixItau\Model\Loc',
'valor' => '\DBSeller\ApiPixItau\Model\CobrancaVencimentoPutRequestPropertiesValor',
'chave' => 'string',
'solicitacao_pagador' => 'string',
'info_adicionais' => '\DBSeller\ApiPixItau\Model\InformacaoAdicional[]',
'txid' => 'string',
'revisao' => 'int',
'recebedor' => '\DBSeller\ApiPixItau\Model\Recebedor',
'status' => 'string',
'pix_copia_e_cola' => 'string',
'pix' => '\DBSeller\ApiPixItau\Model\Pix[]'    ];
...
'pix' => 'getPix'    ];
     ...
     * Gets calendario
     *
     * @return \DBSeller\ApiPixItau\Model\Calendario
     */
     ...
     * Sets calendario
     *
     * @param \DBSeller\ApiPixItau\Model\Calendario $calendario calendario
     *
     * @return $this
     */
     ...
     * Gets devedor
     *
     * @return \DBSeller\ApiPixItau\Model\Devedor
     */
     ...
     * Sets devedor
     *
     * @param \DBSeller\ApiPixItau\Model\Devedor $devedor devedor
     *
     * @return $this
     */
     ...
     * Gets loc
     *
     * @return \DBSeller\ApiPixItau\Model\Loc
     */
     ...
     * Sets loc
     *
     * @param \DBSeller\ApiPixItau\Model\Loc $loc loc
     *
     * @return $this
     */
     ...
     * Gets valor
     *
     * @return \DBSeller\ApiPixItau\Model\CobrancaVencimentoPutRequestPropertiesValor
     */
     ...
     * Sets valor
     *
     * @param \DBSeller\ApiPixItau\Model\CobrancaVencimentoPutRequestPropertiesValor $valor valor
     *
     * @return $this
     */
     ...
     * Sets chave
     *
     * @param string $chave Chave Pix do Sistema DICT - BACEN
     *
     * @return $this
     */
     ...
     *
     * @return \DBSeller\ApiPixItau\Model\InformacaoAdicional[]
     */
     ...
     *
     * @param \DBSeller\ApiPixItau\Model\InformacaoAdicional[] $info_adicionais Cada respectiva informação adicional contida na lista (nome e valor) deve ser apresentada ao pagador
     *
     * @return $this
     */
     ...
     * Gets recebedor
     *
     * @return \DBSeller\ApiPixItau\Model\Recebedor
     */
     ...
     * Sets recebedor
     *
     * @param \DBSeller\ApiPixItau\Model\Recebedor $recebedor recebedor
     *
     * @return $this
     */
     ...
     * Gets pix
     *
     * @return \DBSeller\ApiPixItau\Model\Pix[]
     */
     ...
     * Sets pix
     *
     * @param \DBSeller\ApiPixItau\Model\Pix[] $pix Lista de Pix recebidos
     *
     * @return $this
     */
