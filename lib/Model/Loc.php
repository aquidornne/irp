 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Loc implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'loc';
...
'criacao' => 'getCriacao'    ];
     ...
     * Sets id
     *
     * @param int $id Identificador da URL do PIX para consulta do payload criptografado - pix link BACEN
     *
     * @return $this
     */
     ...
     * Sets location
     *
     * @param string $location URL do PIX para consulta do payload criptografado - pix link BACEN
     *
     * @return $this
     */
     ...
     * Sets tipo_cob
     *
     * @param string $tipo_cob Define se o tipo do documento é imediata ou vencimento <table><tr><td>ENUM</td></tr><tr><td>cob</td></tr><tr><td>cobv</td></tr></table>
     *
     * @return $this
     */
     ...
     * Sets criacao
     *
     * @param string $criacao Data e hora de criacao da localização de cobranças
     *
     * @return $this
     */
