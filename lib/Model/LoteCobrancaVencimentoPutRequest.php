...
class LoteCobrancaVencimentoPutRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'descricao' => 'string',
'cobsv' => '\DBSeller\ApiPixItau\Model\LoteCobrancaVencimentoPutRequestCobsv[]'    ];
...
'cobsv' => 'getCobsv'    ];
     ...
     * Gets cobsv
     *
     * @return \DBSeller\ApiPixItau\Model\LoteCobrancaVencimentoPutRequestCobsv[]
     */
     ...
     * Sets cobsv
     *
     * @param \DBSeller\ApiPixItau\Model\LoteCobrancaVencimentoPutRequestCobsv[] $cobsv Dados enviados para criação ou alteração da cobrança com vencimento via API Pix
     *
     * @return $this
     */
