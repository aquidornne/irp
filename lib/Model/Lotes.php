 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Lotes implements ModelInterface, ArrayAccess
{
...
'criacao' => 'string',
'descricao' => 'string',
'cobsv' => '\DBSeller\ApiPixItau\Model\CobrancaVencimento[]'    ];
...
'cobsv' => 'getCobsv'    ];
     ...
     * Sets cobsv
     *
     * @param \DBSeller\ApiPixItau\Model\CobrancaVencimento[] $cobsv Dados enviados para criação ou alteração da cobrança com vencimento via API Pix
     *
     * @return $this
     */
