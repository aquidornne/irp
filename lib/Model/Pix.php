...
'txid' => 'string',
'valor' => 'string',
'componentes_valor' => '\DBSeller\ApiPixItau\Model\ComponentesValor[]',
'chave' => 'string',
'horario' => 'string',
'info_pagador' => 'string',
'devolucoes' => '\DBSeller\ApiPixItau\Model\Devolucao[]'    ];
...
'devolucoes' => 'getDevolucoes'    ];
     ...
     *
     * @return \DBSeller\ApiPixItau\Model\ComponentesValor[]
     */
     ...
     *
     * @param \DBSeller\ApiPixItau\Model\ComponentesValor[] $componentes_valor O objetivo dessa estrutura é explicar os elementos de composição do valor do Pix, incluindo informações sobre as multas, juros, descontos e abatimentos quando o Pix for relativo a cobranças com vencimento.
     *
     * @return $this
     */
     ...
     * Sets devolucoes
     *
     * @param \DBSeller\ApiPixItau\Model\Devolucao[] $devolucoes Devolucoes registradas no documento
     *
     * @return $this
     */
