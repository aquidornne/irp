...
class ValorDesconto implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'modalidade' => 'int',
'valor_perc' => 'string',
'desconto_data_fixa' => '\DBSeller\ApiPixItau\Model\ValorDescontoDescontoDataFixa[]'    ];
...
'desconto_data_fixa' => 'getDescontoDataFixa'    ];
     ...
     *
     * @return \DBSeller\ApiPixItau\Model\ValorDescontoDescontoDataFixa[]
     */
     ...
     *
     * @param \DBSeller\ApiPixItau\Model\ValorDescontoDescontoDataFixa[] $desconto_data_fixa Data limite para o desconto absoluto da cobrança. (A data de desconto obrigatoriamente deverá ser menor que a data de vencimento da cobrança)
     *
     * @return $this
     */
